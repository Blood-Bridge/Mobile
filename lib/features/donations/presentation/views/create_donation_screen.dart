      ...
      body: BlocConsumer<DonationsCubit, DonationsState>(
        listener: (context, state) {
          if (state is DonationCreateSuccess) {
            Get.back();
            Get.snackbar('Success', 'Donation logged successfully',
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextfield(
                      text: 'Blood Request ID',
                      controller: _requestIdController,
                      keyboardType: TextInputType.number,
                      validator: (v) {
                        if (v == null || v.isEmpty) return 'Request ID is required';
                    ...
                    CustomTextfield(
                      ...
                      keyboardType: TextInputType.number,
                      validator: (v) {
                        if (v == null || v.isEmpty) return 'Hospital ID is required';
                        if (int.tryParse(v) == null) return 'Must be a valid number';
                        return null;
                      },
                    ),
                            ...
                            : () {
                                if (_formKey.currentState!.validate()) {
                                  context.read<DonationsCubit>().createDonation(
                                        bloodRequestId: int.parse(_requestIdController.text),
                                        hospitalId: int.parse(_hospitalIdController.text),
