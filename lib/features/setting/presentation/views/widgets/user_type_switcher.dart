  ...
  void _showSwitchToDonorDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(AppLocalizations.of(context)!.switchToDonor),
        content: Text(AppLocalizations.of(context)!.weightDobEtc),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text(AppLocalizations.of(context)!.text100),
          ),
          ElevatedButton(
            onPressed: () {
              // Example call
            ...
            child: Text(AppLocalizations.of(context)!.text101),
          ),
        ],
      ),
    );
