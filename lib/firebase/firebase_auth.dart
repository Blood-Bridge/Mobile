...
// import 'package:learnify/home/admin_home.dart';
// import 'package:learnify/home/user_home.dart';
...
//
//         if (firstTime) {
//           Get.snackbar(AppLocalizations.of(context)!.sign_in,
//               AppLocalizations.of(context)!.fill_profile,
//               backgroundColor: Colors.green, colorText: Colors.white);
//           Get.offAll(
//               () => FillProfile(
...
//           await getUserData();
//
//           Get.snackbar(AppLocalizations.of(context)!.welcome,
//               AppLocalizations.of(context)!.welcome_message,
//               backgroundColor: Colors.green, colorText: Colors.white);
//           if (HiveHelper.checkIsAdmin() ?? false) {
